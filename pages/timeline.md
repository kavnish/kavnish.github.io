...
`Main highlights from the Obsidian sprint -- Templates are just like commands which you can call on any note or a new note when it's being created. Templator makes the life a lot easier with it's script feature where you can basically do anything that you can do with JS. Commander is a good plugin to add commands to the UI. Also setup hotkeys for doing stuff when you feel need of doing it. Dataview is a good base plugin used to query data based on the meta defined in the frontmatter and many projects like 'project' use it. Project can be setup to have a notion like calender where you can see the notes you created on a given day and color code filter based on the meta field defined in yaml frontmatter. Another good plugin is QuickAdd that makes creating notes, adding to a given notes insanely easy. there is also a pdf annotation plugin which can let you annotate pdfs without downloading them. You can reference the pdf just by mentioning it in the front matter under the target field. Some of the templates I created -- DailyNote, NewNotes, PdfAnnotation, Books. There is so much that can be done with obsidian it's highly extensible and getting into this ecosystem might feel intimidating at first but put some effort it actually offers great value and control. Just don't over do it at the beginning add things as you need them. Don't force your self to tag, link notes, just do it naturally and it will be okay. Obsidian is like a garden which you can keep on working and it will keep giving you fruits that will make you like easier and workflows faster.`


**2023-08-26**

`A big chunk of last week was setting up obsidian and customizing it for comfort. I feel it was a decent investment as now I can tinker my own LLM plugins some of the use cases I was planning for along time (I know there are tons of plugins already there but somehow they just don't fit well perfectly in my workflows).`
